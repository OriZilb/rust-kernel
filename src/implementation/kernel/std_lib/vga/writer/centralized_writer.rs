...
pub static GLOBAL_WRITER: Mutex<Writer> = Mutex::new(Writer::new());

pub fn print(string: &str) {
        GLOBAL_WRITER.lock().print(string);
}

pub fn print_colored(string: &str, foreground: crate::std_lib::vga::ColorCodeVga, background: crate::std_lib::vga::ColorCodeVga) {
    GLOBAL_WRITER.lock().print_colored(string, foreground, background);
}
...
pub fn println_colored(string: &str, foreground: crate::std_lib::vga::ColorCodeVga, background: crate::std_lib::vga::ColorCodeVga) {
    GLOBAL_WRITER.lock().println_colored(string, foreground, background);
}
